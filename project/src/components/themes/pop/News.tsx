...
export default function News() {
  ...
  return (
    <section id="news" className="scroll-mt-20 bg-white py-16 sm:py-16 md:py-24 md:py-28 lg:py-32 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-sans font-black tracking-tight text-[#2D2D2D] tracking-tighter mb-4 border-b-8 border-[#FF006E] pb-4 inline-block mb-4">
            {sectionTitle}
          </h2>
          ...
          {newsData.items.map((item: any, index: number) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ x: 6 }}
                className="group bg-white rounded-2xl border border-[#FFBE0B]/30 hover:border-[#FFBE0B] hover:shadow-md p-6 md:p-8 transition-colors cursor-pointer"
              >
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="flex items-center gap-4 flex-shrink-0">
                    <div className="bg-[#FFFFFF] p-3 rounded-xl border border-[#FFBE0B]">
                      
                    </div>
                    <div>
                      <p className="text-sm text-[#2D2D2D] font-medium">{date}</p>
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#7B2FBE] text-white text-xs font-sans font-black tracking-tight uppercase tracking-widest rounded-lg mt-1">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-sans font-black tracking-tight text-[#2D2D2D] tracking-tight mb-2 group-hover:text-[#FB5607] transition-colors">
                      {title}
                    </h3>
