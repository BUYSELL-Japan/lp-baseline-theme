  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${
        scrolled 
          ? 'py-3 bg-[#FFFBF0]/95 backdrop-blur-xl border-b border-[#D97706]/20 shadow-2xl' 
          : 'py-6 bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between gap-4">
        ...
        >
          ...
          <div className="text-sm sm:text-xl font-sans font-bold tracking-normal text-[#1C1917] break-words leading-tight">
            {logoText}
          </div>
        </motion.div>
