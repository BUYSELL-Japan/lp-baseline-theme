                ...
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="flex items-center gap-4 flex-shrink-0">
                    ...
                    <div>
                      ...
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#DC2626] text-white text-xs font-sans font-black uppercase tracking-widest rounded-lg mt-1">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-sans font-black tracking-tighter text-gray-100 mb-2 group-hover:text-[#F59E0B] transition-colors">
                      {title}
                    </h3>
