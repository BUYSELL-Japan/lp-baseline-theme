...
export default function Contact() {
  ...
  const inputBase = "w-full px-5 py-4 rounded-xl bg-[#141414] border-2 border-[#F59E0B]/30 text-gray-100 placeholder-slate-400 focus:outline-none transition-colors disabled:opacity-60 disabled:cursor-not-allowed";
  const inputFocused = "border-[#F59E0B]";
    ...
    <section id="contact" className="py-16 sm:py-12 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#141414]">
      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        <motion.form
          ...
          className="bg-[#141414] rounded-3xl border border-[#F59E0B]/30 p-8 md:p-12 shadow-xl"
        >
          {/* Honeypot */}
