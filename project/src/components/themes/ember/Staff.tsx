...
export default function Staff() {
  ...
  return (
    <section id="staff" className="py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#0a0a0a]">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          {staffData.sectionSubtitle && (
            <p className="text-xl text-gray-400">{t(staffData, 'sectionSubtitle')}</p>
          )}
        </motion.div>
        ...
        <div className={`grid grid-cols-1 ${
          ...
          {validMembers.map((member, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group bg-[#1a1a1a] rounded-3xl border border-[#D4AF37]/20 hover:border-[#D4AF37]/40 overflow-hidden transition-colors"
            >
              {/* Image */}
              <div className="aspect-[4/3] overflow-hidden bg-[#2a2a2a] relative">
                <img
                  src={member.image}
                  alt={t(member, 'name')}
              ...
              {/* Info */}
              <div className="p-8">
                <p className="text-xs font-serif font-bold tracking-wide uppercase tracking-[0.3em] text-[#D4AF37] mb-2">
                  {t(member, 'role')}
                </p>
                <h3 className="text-2xl font-serif font-bold tracking-wide text-white tracking-tighter mb-4">
                  {t(member, 'name')}
                </h3>
