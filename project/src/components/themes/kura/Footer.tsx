...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#FFFFFF] text-[#2D2D2D] pt-16 sm:pt-20 lg:pt-24 pb-10 sm:pb-12 px-4 sm:px-6 border-t border-[#C0392B]/30">
          ...
          {footerData.businessHours && (
            <div>
              ...
              <div className="space-y-4">
                <p className="text-[#2D2D2D] font-serif tracking-widest text-xl">{getText(footerData.businessHours.days)}</p>
                  ...
                  {validLinks.map((social, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        whileTap={{ scale: 0.9 }}
                        className="w-12 h-12 bg-[#FFFFFF] border border-[#C0392B]/20 rounded-2xl flex items-center justify-center hover:bg-[#F5F0E8] hover:border-[#C0392B]/50 transition-colors"
                      >
                        SNS
                      </motion.a>
                    );
