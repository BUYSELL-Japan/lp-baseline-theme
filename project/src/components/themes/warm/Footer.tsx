    ...
    <footer className="bg-[#FFFBF0] text-[#1C1917] pt-16 sm:pt-20 lg:pt-24 pb-10 sm:pb-12 px-4 sm:px-6 border-t border-[#D97706]/30">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-8 group">
              ...
              <span className="text-4xl font-sans font-bold tracking-normal font-bold tracking-wide tracking-tighter uppercase">{logoText}</span>
            </div>
          ...
          {footerData.businessHours && (
            <div>
              <h3 className="text-sm font-sans font-bold tracking-normal font-bold tracking-wide uppercase tracking-[0.2em] text-[#D97706] mb-8">
                {getText(footerData.businessHours.title)}
              </h3>
              <div className="space-y-4">
                <p className="text-[#1C1917] font-sans font-bold tracking-normal font-bold tracking-wide text-xl">{getText(footerData.businessHours.days)}</p>
        ...
        <div className="pt-12 border-t border-[#D97706]/30 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[#92400E] text-sm font-sans font-bold tracking-normal font-bold tracking-widest uppercase">
