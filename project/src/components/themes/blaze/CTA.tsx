...
export default function CTA() {
  ...
  return (
    <section className="relative py-16 sm:py-12 md:py-28 lg:py-32 px-4 sm:px-6 overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Blue glow accents */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#DC2626]/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#DC2626]/10 rounded-full blur-[120px] pointer-events-none" />
