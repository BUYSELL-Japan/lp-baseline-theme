          ...
          >
            {accessData.address && (
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-1">{translate('address', language)}</h3>
            ...
            {hasParking && (
              <div className="border-t border-[#D97706]/30 pt-6 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-1">{getText(accessData.parking.title)}</h3>
                  ...
                  {accessData.parking.spaces && (
                    <p className="text-[#D97706] font-sans font-bold tracking-normal font-bold text-sm">
            ...
            {hasTransportation && (
              <div className="border-t border-[#D97706]/30 pt-6 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-3">{getText(accessData.transportation.title)}</h3>
                    ...
                    {accessData.transportation.methods && Array.isArray(accessData.transportation.methods) &&
                      accessData.transportation.methods.map((method, index) => (
                        <div key={index} className="flex items-start gap-2">
                          ...
                          <div>
                            <span className="font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] text-sm">{getText(method.type)}:</span>
