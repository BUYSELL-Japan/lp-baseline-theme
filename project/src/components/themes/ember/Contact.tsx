...
export default function Contact() {
  ...
  const inputBase = "w-full px-5 py-4 rounded-xl bg-[#141414] border-2 border-[#D4AF37]/30 text-gray-100 placeholder-slate-400 focus:outline-none transition-colors disabled:opacity-60 disabled:cursor-not-allowed";
  const inputFocused = "border-[#D4AF37]";
    ...
    <section id="contact" className="scroll-mt-20 py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#141414]">
      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        <motion.form
          ...
          className="bg-[#141414] rounded-3xl border border-[#D4AF37]/30 p-8 md:p-12 shadow-xl"
        >
          {/* Honeypot */}
          ...
          <div className="space-y-6">
            {/* Name */}
            <div>
              <label htmlFor="name-t2" className="block text-sm font-serif font-bold text-gray-200 uppercase tracking-widest mb-2">
            ...
            {/* Email */}
            <div>
              <label htmlFor="email-t2" className="block text-sm font-serif font-bold text-gray-200 uppercase tracking-widest mb-2">
            ...
            {/* Subject */}
            <div>
              <label htmlFor="subject-t2" className="block text-sm font-serif font-bold text-gray-200 uppercase tracking-widest mb-2">
            ...
            {/* Message */}
            <div>
              <label htmlFor="message-t2" className="block text-sm font-serif font-bold text-gray-200 uppercase tracking-widest mb-2">
            ...
            <motion.button
              ...
              className="w-full bg-[#8B0000] hover:bg-[#8B0000] text-white py-5 rounded-2xl font-serif font-bold tracking-wide text-lg shadow-2xl shadow-[#8B0000]/30 flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
            ...
            <AnimatePresence>
              {submitStatus === 'success' && (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-4 bg-[#1a1a1a] border border-[#D4AF37] rounded-xl text-[#D4AF37]"
                >
                  <CheckCircle className="w-5 h-5 flex-shrink-0" />
                  <span className="text-sm font-serif font-bold">{translate('contactSuccess')}</span>
                </motion.div>
              )}
              {submitStatus === 'error' && (
                <motion.div
                ...
                >
                  ...
                  <span className="text-sm font-serif font-bold">{translate('contactError')}</span>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
