        ...
        <div className="space-y-6">
          ...
          {hasPhilosophy && (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="bg-[#1a1a1a] rounded-3xl border border-[#D4AF37]/20 p-8 md:p-12"
            >
              ...
              <div className="relative">
                ...
                <div className="space-y-6">
                  {companyData.history.timeline.map((item, index) => (
                    ...
                    >
                      <div className="absolute left-0 top-1 w-8 h-8 bg-[#8B0000] rounded-full flex items-center justify-center">
                        <div className="w-2.5 h-2.5 bg-[#141414] rounded-full" />
                      </div>
                      <div className="bg-[#0a0a0a] rounded-xl p-4 border border-[#D4AF37]/20">
                        <div className="font-serif font-bold tracking-wide text-[#D4AF37] mb-1">{getText(item.year)}</div>
