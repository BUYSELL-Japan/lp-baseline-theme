    ...
    <section id="storeInfo" className="scroll-mt-20 py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#141414]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-serif font-bold tracking-wide text-gray-100 border-b-2 border-[#D4AF37] pb-4 inline-block mb-4">
            {sectionTitle}
          </h2>
        </motion.div>
          ...
          >
            <div className="aspect-video bg-[#1a1a1a] relative">
              ...
              <div className="absolute bottom-6 left-8 text-white">
                <p className="text-2xl font-serif font-bold tracking-wide">{t(storeInfoData, 'mainImageCaption')}</p>
              </div>
            </div>
          </motion.div>
        )}
