      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          {faqData.sectionSubtitle && (
            <p className="text-xl text-gray-200">{getText(faqData.sectionSubtitle)}</p>
          )}
        </motion.div>
        ...
        <div className="space-y-3">
          {faqData.items.map((item, index) => (
            <motion.div
              ...
              className="bg-[#141414] rounded-2xl border border-[#D4AF37]/30 overflow-hidden hover:border-[#D4AF37] transition-colors"
            >
              <button
              ...
              >
                <div className="px-6 pb-6 pt-0">
                  <div className="border-t border-[#D4AF37]/30 pt-4">
                    <p className="text-gray-200 leading-relaxed">{getText(item.answer)}</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
