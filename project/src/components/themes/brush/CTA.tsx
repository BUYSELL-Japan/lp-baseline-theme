...
export default function CTA() {
  ...
  return (
    <section className="bg-[#1a1a1a] text-white relative py-24 md:py-32 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-serif tracking-widest text-white tracking-tighter mb-6 border-b-2 border-[#C0392B] pb-4 inline-block mb-4">
              ...
              <motion.a
                ...
                className={`inline-flex items-center gap-3 px-10 py-5 rounded-2xl text-lg font-serif tracking-widest transition-all shadow-2xl ${
                  button.type === 'primary'
                    ...
                    : 'bg-[#F5F0E8]/80 text-white border border-[#C0392B]/30 hover:bg-transparent border border-white/20'
                }`}
              >
