        ...
        <div className={`grid grid-cols-1 ${
          ...
          {validMembers.map((member, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group bg-[#FFFFFF] rounded-3xl border border-[#C0392B]/20 hover:border-[#C0392B]/40 overflow-hidden transition-colors"
            >
              {/* Image */}
              ...
              <div className="p-8">
                ...
                <h3 className="text-2xl font-serif tracking-widest text-[#2D2D2D] tracking-tighter mb-4">
                  {t(member, 'name')}
                </h3>
