...
var require_lucide_react = __commonJS({
  "node_modules/lucide-react/dist/cjs/lucide-react.js"(exports2) {
    ...
    var createLucideIcon = (iconName, iconNode) => {
      const Component3 = react.forwardRef(
        ({
          color = "currentColor",
          size = 24,
          strokeWidth = 2,
    ...
    var Component2 = createLucideIcon("Component", [
    ...
    var Contact3 = createLucideIcon("Contact", [
    ...
    var Menu2 = createLucideIcon("Menu", [
    ...
    exports2.ComponentIcon = Component2;
    ...
    exports2.LucideComponent = Component2;
    ...
    exports2.LucideContact = Contact3;
...
// src/components/ThemeWarmStorePage.tsx
var ThemeWarmStorePage_exports = {};
__export(ThemeWarmStorePage_exports, {
  default: () => ThemeWarmStorePage
});
module.exports = __toCommonJS(ThemeWarmStorePage_exports);
var import_react13 = require("react");

// src/components/themes/warm/Header.tsx
var import_react3 = require("react");
var import_framer_motion = require("framer-motion");

// src/contexts/PageDataContext.tsx
...
var PageDataContext = (0, import_react.createContext)(getDefaultPageData());
function PageDataProvider({ children, data }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageDataContext.Provider, { value: data, children });
}
function usePageData() {
  return (0, import_react.useContext)(PageDataContext);
}
function useHeaderData() {
  const { header } = (0, import_react.useContext)(PageDataContext);
  return header;
}
function useHeroData() {
  const { hero } = (0, import_react.useContext)(PageDataContext);
  return hero;
}
function useAboutData() {
  const { about } = (0, import_react.useContext)(PageDataContext);
  return about;
}
function useMenuData() {
  const { menu } = (0, import_react.useContext)(PageDataContext);
  return menu;
}
function useStoreInfoData() {
  const { storeInfo } = (0, import_react.useContext)(PageDataContext);
  return storeInfo;
}
function useContactData() {
  const { contact } = (0, import_react.useContext)(PageDataContext);
  return contact;
}
function useContactEmail() {
  const { contactEmail } = (0, import_react.useContext)(PageDataContext);
  return contactEmail || "";
}
function useFooterData() {
  const { footer } = (0, import_react.useContext)(PageDataContext);
  return footer;
}
function useGalleryData() {
  const { gallery } = (0, import_react.useContext)(PageDataContext);
  return gallery;
}
function useStaffData() {
  const { staff } = (0, import_react.useContext)(PageDataContext);
  return staff;
}
function useNewsData() {
  const { news } = (0, import_react.useContext)(PageDataContext);
  return news;
}
function useAccessData() {
  const { access } = (0, import_react.useContext)(PageDataContext);
  return access;
}
function useFAQData() {
  const { faq } = (0, import_react.useContext)(PageDataContext);
  return faq;
}
function useCTAData() {
  const { cta } = (0, import_react.useContext)(PageDataContext);
  return cta;
}
function usePricingData() {
  const { pricing } = (0, import_react.useContext)(PageDataContext);
  return pricing;
}
function useCompanyData() {
  const { company } = (0, import_react.useContext)(PageDataContext);
  return company;
}
...
function LanguageProvider({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(LanguageContext.Provider, { value: { language, setLanguage, basePath }, children });
}
function useLanguage() {
  return (0, import_react2.useContext)(LanguageContext);
}
var languageNames = {
  ja: "\u65E5\u672C\u8A9E",
  en: "English",
...
function getNewsCategory(category, language) {
  if (!category) return "";
...
function getLocalizedValue(obj, key, language) {
  if (!obj) return "";
  const value = obj[key];
  if (value && typeof value === "object" && !Array.isArray(value)) {
    if (value[language] !== void 0) {
...
function Header() {
  const headerData2 = useHeaderData();
  ...
  if (!headerData2) return null;
  const visibleSectionIds = /* @__PURE__ */ new Set([
  ...
  const navigation = Array.isArray(headerData2.navigation) ? headerData2.navigation.filter((item) => visibleSectionIds.has(item.id)) : [];
  ...
  const logoText = getLocalizedValue(headerData2.logo, "text", language);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-[100] transition-all duration-500 ${scrolled ? "py-3 bg-[#FFFBF0]/95 backdrop-blur-xl border-b border-[#D97706]/20 shadow-2xl" : "py-6 bg-transparent"}`,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "max-w-7xl mx-auto px-6 flex items-center justify-between gap-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
            import_framer_motion.motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "w-10 h-10 shrink-0 bg-[#92400E] rounded-xl flex items-center justify-center shadow-lg shadow-[#92400E]/30 group-hover:bg-[#92400E] transition-colors" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-sm sm:text-xl font-sans font-bold tracking-normal font-bold tracking-wide tracking-tighter text-[#1C1917] line-clamp-2 leading-tight", children: logoText })
              ]
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("nav", { className: "hidden xl:flex flex-wrap items-center justify-end gap-x-4 gap-y-2 max-w-full", children: navigation.map((item) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              ...
              children: getLocalizedValue(item, "label", language)
            },
            item.id
          )) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex items-center gap-2 text-amber-900/80", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "select",
            {
              value: language,
              ...
              children: Object.keys(languageNames).map((lang) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("option", { value: lang, className: "bg-[#FFFBF0]", children: languageNames[lang] }, lang))
            }
          ) }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "button",
            {
              ...
              children: mobileMenuOpen ? "\u9589\u3058\u308B" : "\u30E1\u30CB\u30E5\u30FC"
            }
          )
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_framer_motion.AnimatePresence, { children: mobileMenuOpen && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          import_framer_motion.motion.div,
          {
            ...
            className: "fixed inset-0 bg-[#FFFBF0] z-[110] flex flex-col pt-20 xl:hidden",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                "button",
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex-1 overflow-y-auto px-8 py-6 space-y-2", children: navigation.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "px-8 py-6 border-t border-[#D97706]/20", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs font-sans font-bold tracking-normal font-bold text-[#1C1917] uppercase tracking-widest mb-3", children: translate("languageLabel", language) }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "grid grid-cols-2 gap-2", children: Object.keys(languageNames).map((lang) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
                  "a",
                  {
...
// src/components/themes/warm/Hero.tsx
var import_react4 = require("react");
var import_framer_motion2 = require("framer-motion");
var import_jsx_runtime4 = require("react/jsx-runtime");
function Hero() {
  const heroData2 = useHeroData();
  const { language } = useLanguage();
  if (!heroData2) return null;
  const title = getLocalizedValue(heroData2, "title", language);
  const subtitle = getLocalizedValue(heroData2, "subtitle", language);
  if (!title && !subtitle && !heroData2.backgroundImage) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("section", { className: "relative pt-32 pb-12 px-4 sm:px-6 lg:px-8 bg-[#FFFBF0]", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      import_framer_motion2.motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "absolute -top-20 -right-20 w-64 h-64 bg-[#D97706] rounded-full blur-[100px] opacity-20 pointer-events-none" }),
          heroData2.backgroundImage && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "w-full md:w-1/2 h-64 md:h-[450px] relative", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "img",
            {
              src: heroData2.backgroundImage,
              alt: title || "Hero",
              className: "w-full h-full object-cover"
            }
          ) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white relative z-10", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h1", { className: "text-4xl md:text-5xl lg:text-6xl font-black text-[#1C1917] leading-tight mb-6", children: title }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "w-16 h-2 bg-[#D97706] rounded-full mb-8" }),
    ...
    subtitle && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      import_framer_motion2.motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-[#D97706] mr-3 font-black text-2xl leading-none" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-[#92400E] font-bold text-lg", children: subtitle })
        ]
      }
    )
  ] }) });
...
// src/components/themes/warm/About.tsx
var import_react5 = require("react");
var import_framer_motion3 = require("framer-motion");
var import_jsx_runtime5 = require("react/jsx-runtime");
function About() {
  const aboutData2 = useAboutData();
  const { language } = useLanguage();
  if (!aboutData2 || !aboutData2.title && !aboutData2.description && (!aboutData2.features || aboutData2.features.length === 0)) return null;
  const title = getLocalizedValue(aboutData2, "title", language);
  const description = getLocalizedValue(aboutData2, "description", language);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("section", { id: "about", className: "py-24 bg-[#FEF3C7]", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "max-w-6xl mx-auto px-6", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "text-center mb-16", children: [
      title && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("h2", { className: "text-4xl md:text-5xl font-black text-[#92400E] mb-6 inline-block relative", children: [
        title,
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-1 bg-[#D97706] rounded-full" })
      ] }),
      description && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "text-lg md:text-xl text-[#1C1917] font-medium max-w-3xl mx-auto leading-relaxed mt-10", children: description })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "space-y-24 mt-20", children: aboutData2.features?.map((feature, index) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `flex flex-col ${isReverse ? "md:flex-row-reverse" : "md:flex-row"} items-center gap-12 lg:gap-20`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-full md:w-1/2 flex justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "relative", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "absolute -inset-4 bg-[#D97706]/30 rounded-full blur-xl" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-8 border-white shadow-xl relative z-10", children: feature.image ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("img", { src: feature.image, alt: featTitle, className: "w-full h-full object-cover" }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "w-full h-full bg-[#FFFBF0]" }) })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "w-full md:w-1/2 text-center md:text-left", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "inline-block bg-[#D97706] text-white px-5 py-2 rounded-full text-sm font-bold mb-6 shadow-sm", children: [
            "\u3053\u3060\u308F\u308A ",
            index + 1
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h3", { className: "text-3xl lg:text-4xl font-black text-[#92400E] mb-6 leading-tight", children: featTitle }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "text-lg text-[#1C1917] leading-relaxed font-medium", children: featDesc })
        ] })
      ] }, index);
    }) })
  ] }) });
...
// src/components/themes/warm/Menu.tsx
...
function Menu() {
  ...
  const { language } = useLanguage();
  if (!menuData2 || !menuData2.categories || menuData2.categories.length === 0) return null;
  const sectionTitle = getLocalizedValue(menuData2, "sectionTitle", language) || "Menu";
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("section", { id: "menu", className: "py-20 bg-[#FFFBF0]", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "text-center mb-16", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h2", { className: "text-4xl md:text-5xl font-black text-[#92400E] inline-block relative", children: [
      sectionTitle,
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-1 bg-[#D97706] rounded-full" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "space-y-20", children: menuData2.categories.map((category, catIndex) => {
      const catName = getLocalizedValue(category, "name", language);
      if (!category.items || category.items.length === 0) return null;
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("h3", { className: "text-2xl md:text-3xl font-bold mb-8 text-[#1C1917] flex items-center gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "w-2 h-8 bg-[#D97706] rounded-full" }),
          catName
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6", children: category.items.map((item, itemIndex) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            import_framer_motion4.motion.div,
            {
              ...
              viewport: { once: true },
              transition: { delay: itemIndex % 4 * 0.05 },
              className: "bg-white rounded-3xl overflow-hidden shadow-[0_4px_15px_rgb(146,64,14,0.05)] border-2 border-[#FEF3C7] hover:border-[#D97706] transition-colors group flex flex-col h-full",
              children: [
                item.image ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "aspect-square w-full overflow-hidden p-2", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("img", { src: item.image, alt: itemName, className: "w-full h-full object-cover rounded-2xl group-hover:scale-105 transition-transform duration-500" }) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "aspect-square w-full bg-[#FEF3C7] m-2 rounded-2xl flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "text-4xl" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "p-4 flex flex-col flex-grow justify-between bg-white text-center", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h4", { className: "text-lg sm:text-xl font-bold text-[#1C1917] leading-tight mb-2", children: itemName }),
                    itemDesc && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "text-sm text-amber-900/70 line-clamp-2 mb-3 font-medium", children: itemDesc })
                  ] }),
                  /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "text-lg font-black text-[#D97706]", children: [
                    "\xA5",
...
// src/components/themes/warm/Pricing.tsx
...
function useLocalize() {
  ...
  function getText(field) {
    ...
    if (typeof field === "object" && field !== null && !Array.isArray(field)) {
      ...
      if (field[language] !== void 0 && field[language] !== null) {
        return String(field[language]).trim();
      }
      if (language === "zh-tw" && field["zh"] !== void 0 && field["zh"] !== null) {
        return String(field["zh"]).trim();
      }
      if (field["ja"] !== void 0 && field["ja"] !== null) {
        return String(field["ja"]).trim();
      }
      const firstKey = Object.keys(field)[0];
      if (firstKey && field[firstKey] !== void 0 && field[firstKey] !== null) {
...
function Pricing() {
  const pricingData2 = usePricingData();
  const { getText } = useLocalize();
  const { language } = useLanguage();
  if (!pricingData2 || !pricingData2.plans) return null;
  if (!getText(pricingData2.sectionTitle)) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("section", { id: "pricing", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white border-t border-[#D97706]/30", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      import_framer_motion5.motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-6 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: getText(pricingData2.sectionTitle) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "w-20 h-2 bg-[#92400E] mx-auto mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: "text-xl text-[#1C1917] font-medium max-w-2xl mx-auto", children: getText(pricingData2.sectionSubtitle) })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: pricingData2.plans.map((plan, index) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
      import_framer_motion5.motion.div,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        className: `relative p-8 rounded-[2.5rem] flex flex-col h-full overflow-hidden transition-all duration-500 ${plan.isPopular ? "bg-[#92400E] scale-105 shadow-[0_0_80px_rgba(37,99,235,0.25)] z-10" : "bg-white border border-[#D97706]/30 hover:border-[#D97706] hover:shadow-lg"}`,
        children: [
          plan.isPopular && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "absolute top-8 right-8 text-[#1C1917]/50" }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "mb-10 relative", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h3", { className: `text-2xl font-sans font-bold tracking-normal font-bold tracking-wide mb-2 tracking-tight ${plan.isPopular ? "text-[#1C1917]" : "text-[#1C1917]"}`, children: getText(plan.name) }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("p", { className: `text-sm font-medium ${plan.isPopular ? "text-[#1C1917]" : "text-[#1C1917]"}`, children: getText(plan.description) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "mb-10", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `text-5xl font-sans font-bold tracking-normal font-bold tracking-wide tracking-tighter ${plan.isPopular ? "text-[#1C1917]" : "text-[#D97706]"}`, children: getText(plan.price) }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `text-xs font-sans font-bold tracking-normal font-bold uppercase tracking-widest mt-2 ${plan.isPopular ? "text-[#1C1917]" : "text-amber-900/80"}`, children: translate("taxIncluded", language) })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("ul", { className: "space-y-4 mb-10 flex-grow", children: plan.features?.map((feature, idx) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: `mt-1 p-0.5 rounded-full ${plan.isPopular ? "bg-[#92400E]/20" : "bg-[#FFFBF0] text-[#D97706]"}` }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { className: `text-sm font-medium leading-tight ${plan.isPopular ? "text-[#1C1917]" : "text-[#1C1917]"}`, children: getText(feature) })
          ] }, idx)) }),
          /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
            import_framer_motion5.motion.a,
            {
              href: "#contact",
              whileHover: { scale: 1.05 },
              whileTap: { scale: 0.95 },
              className: `w-full py-5 rounded-2xl font-sans font-bold tracking-normal font-bold tracking-wide text-center transition-all ${plan.isPopular ? "bg-white text-[#D97706] hover:bg-[#FFFBF0]" : "bg-[#92400E] text-white hover:bg-[#92400E] shadow-lg shadow-[#92400E]/30"}`,
              children: translate("bookingContact", language)
            }
          )
        ]
      },
...
// src/components/themes/warm/CTA.tsx
var import_framer_motion6 = require("framer-motion");

// src/components/SectionError.tsx
function SectionError({ sectionName, error }) {
...
function CTA() {
  const ctaData2 = useCTAData();
  const { getText } = useLocalize();
  if (!ctaData2) return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SectionError, { sectionName: "CTA", error: "No CTA data available", data: ctaData2 });
  const sectionTitle = getText(ctaData2.sectionTitle);
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SectionError, { sectionName: "CTA", error: "Missing section title", data: ctaData2 });
  if (!ctaData2.buttons || !Array.isArray(ctaData2.buttons) || ctaData2.buttons.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SectionError, { sectionName: "CTA", error: "No CTA buttons found.", data: ctaData2 });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("section", { className: "relative py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 overflow-hidden bg-[#FFFBF0]", children: [
    ctaData2.backgroundImage && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: "absolute inset-0 z-0", children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("img", { src: ctaData2.backgroundImage, alt: "Background", className: "w-full h-full object-cover opacity-45" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "absolute inset-0 bg-gradient-to-r from-slate-950 via-[#0a0a0a]/50 to-slate-950/75" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "absolute top-0 left-1/4 w-96 h-96 bg-[#92400E]/20 rounded-full blur-[120px] pointer-events-none" }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "absolute bottom-0 right-1/4 w-96 h-96 bg-[#92400E]/10 rounded-full blur-[120px] pointer-events-none" }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
      import_framer_motion6.motion.div,
      {
        ...
        transition: { duration: 0.6 },
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mx-auto mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-6 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: getText(ctaData2.sectionTitle) }),
          ctaData2.sectionSubtitle && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "text-xl text-[#D97706] font-sans font-bold tracking-normal font-bold mb-4", children: getText(ctaData2.sectionSubtitle) }),
          ctaData2.description && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("p", { className: "text-lg text-amber-900/80 mb-12 max-w-2xl mx-auto leading-relaxed", children: getText(ctaData2.description) }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: ctaData2.buttons.map((button, index) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
            import_framer_motion6.motion.a,
            {
              href: button.link,
              whileHover: { scale: 1.05, y: -3 },
              whileTap: { scale: 0.97 },
              className: `inline-flex items-center gap-3 px-10 py-5 rounded-2xl text-lg font-sans font-bold tracking-normal font-bold tracking-wide transition-all shadow-2xl ${button.type === "primary" ? "bg-[#92400E] text-white hover:bg-[#92400E] shadow-[#92400E]/30" : "bg-[#FEF3C7]/80 text-[#1C1917] border border-[#D97706]/30 hover:bg-[#FFFBF0]"}`,
              children: getText(button.text)
            },
            index
          )) })
        ]
...
// src/components/themes/warm/Gallery.tsx
var import_react8 = require("react");
var import_jsx_runtime9 = require("react/jsx-runtime");
function Gallery() {
  const galleryData2 = useGalleryData();
  const { language } = useLanguage();
  if (!galleryData2 || !galleryData2.images || galleryData2.images.length === 0) return null;
  const sectionTitle = getLocalizedValue(galleryData2, "sectionTitle", language) || "Gallery";
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("section", { id: "gallery", className: "py-24 bg-[#FFFBF0] overflow-hidden", children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "max-w-7xl mx-auto px-6 mb-12 text-center", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("h2", { className: "text-4xl md:text-5xl font-black text-[#92400E] inline-block relative", children: [
      sectionTitle,
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { className: "absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-1 bg-[#D97706] rounded-full" })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "w-full overflow-x-auto pb-12 pt-4 hide-scrollbar cursor-grab active:cursor-grabbing", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "flex gap-6 px-6 md:px-12 w-max", children: galleryData2.images.map((img, index) => {
      const caption = getLocalizedValue(img, "caption", language);
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "w-64 sm:w-80 flex-shrink-0 group", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { className: "bg-white p-4 rounded-3xl shadow-lg border border-[#FEF3C7] transform transition-all duration-300 group-hover:-translate-y-3 group-hover:rotate-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "w-full aspect-square overflow-hidden rounded-2xl", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
          "img",
          {
            src: img.url,
            alt: caption || "",
        ...
        caption && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { className: "pt-4 pb-2 text-center", children: /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h3", { className: "text-[#1C1917] font-bold", children: caption }) })
      ] }) }, index);
    }) }) }),
...
// src/components/themes/warm/Staff.tsx
var import_framer_motion7 = require("framer-motion");
var import_jsx_runtime10 = require("react/jsx-runtime");
function Staff() {
  const staffData2 = useStaffData();
  const { t } = useLocalize();
  if (!staffData2) return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SectionError, { sectionName: "Staff", error: "No staff data available", data: staffData2 });
  const sectionTitle = t(staffData2, "sectionTitle");
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SectionError, { sectionName: "Staff", error: "Missing section title", data: staffData2 });
  const validMembers = staffData2.members.filter((member) => {
    const name = t(member, "name");
    return name && name.trim() !== "" || member.image && member.image.trim() !== "";
  });
  if (!staffData2.members || !Array.isArray(staffData2.members) || validMembers.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SectionError, { sectionName: "Staff", error: "No staff members found.", data: staffData2 });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("section", { id: "staff", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#FFFBF0]", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      import_framer_motion7.motion.div,
      {
        ...
        className: "mb-16",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-4 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: sectionTitle }),
          staffData2.sectionSubtitle && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-xl text-amber-900/80", children: t(staffData2, "sectionSubtitle") })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: `grid grid-cols-1 ${validMembers.length === 1 ? "max-w-sm mx-auto" : validMembers.length === 2 ? "md:grid-cols-2 max-w-4xl mx-auto" : "md:grid-cols-2 lg:grid-cols-3"} gap-6`, children: validMembers.map((member, index) => /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(
      import_framer_motion7.motion.div,
      {
        initial: { opacity: 0, y: 30 },
        whileInView: { opacity: 1, y: 0 },
        ...
        transition: { duration: 0.6, delay: Math.min(index * 0.08, 0.4) },
        whileHover: { y: -8 },
        className: "group bg-[#FFFBF0] rounded-3xl border border-[#D97706]/20 hover:border-[#D97706]/40 overflow-hidden transition-colors",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "aspect-[4/3] overflow-hidden bg-[#FEF3C7] relative", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-[#1a1a1a]/90 to-transparent" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "p-8", children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-xs font-sans font-bold tracking-normal font-bold tracking-wide uppercase tracking-[0.3em] text-[#D97706] mb-2", children: t(member, "role") }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("h3", { className: "text-2xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-4", children: t(member, "name") }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-amber-900/80 leading-relaxed text-sm", children: t(member, "description") })
          ] })
        ]
      },
      index
...
// src/components/themes/warm/News.tsx
var import_framer_motion8 = require("framer-motion");
var import_jsx_runtime11 = require("react/jsx-runtime");
function News() {
  const newsData2 = useNewsData();
  const { getText, getCategory } = useLocalize();
  if (!newsData2) return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SectionError, { sectionName: "News", error: "No news data available", data: newsData2 });
  const sectionTitle = getText(newsData2.sectionTitle);
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SectionError, { sectionName: "News", error: "Missing section title", data: newsData2 });
  if (!newsData2.items || !Array.isArray(newsData2.items) || newsData2.items.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SectionError, { sectionName: "News", error: "No news items found.", data: newsData2 });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("section", { id: "news", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white", children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
      import_framer_motion8.motion.div,
      {
        ...
        className: "mb-16",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-4 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: sectionTitle }),
          newsData2.sectionSubtitle && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { className: "text-xl text-[#1C1917]", children: getText(newsData2.sectionSubtitle) })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "space-y-4", children: newsData2.items.map((item, index) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        import_framer_motion8.motion.div,
        {
          ...
          transition: { duration: 0.6, delay: Math.min(index * 0.08, 0.4) },
          whileHover: { x: 6 },
          className: "group bg-white rounded-2xl border border-[#D97706]/30 hover:border-[#D97706] hover:shadow-md p-6 md:p-8 transition-colors cursor-pointer",
          children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex flex-col md:flex-row md:items-center gap-6", children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex items-center gap-4 flex-shrink-0", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "bg-[#FFFBF0] p-3 rounded-xl border border-[#D97706]" }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { className: "text-sm text-[#1C1917] font-medium", children: date }),
                /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "inline-flex items-center gap-1.5 px-3 py-1 bg-[#92400E] text-white text-xs font-sans font-bold tracking-normal font-bold tracking-wide uppercase tracking-widest rounded-lg mt-1", children: category })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "flex-grow", children: [
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h3", { className: "text-xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tight mb-2 group-hover:text-[#D97706] transition-colors", children: title }),
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("p", { className: "text-[#1C1917] leading-relaxed text-sm", children: content })
            ] })
          ] })
        },
        index
...
// src/components/themes/warm/StoreInfo.tsx
var import_framer_motion9 = require("framer-motion");
var import_jsx_runtime12 = require("react/jsx-runtime");
function StoreInfo() {
  const storeInfoData2 = useStoreInfoData();
  const { t } = useLocalize();
  if (!storeInfoData2) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SectionError, { sectionName: "Store Info", error: "No store information data available", data: storeInfoData2 });
  const sectionTitle = t(storeInfoData2, "sectionTitle");
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SectionError, { sectionName: "Store Info", error: "Missing section title", data: storeInfoData2 });
  if (!storeInfoData2.items || !Array.isArray(storeInfoData2.items) || storeInfoData2.items.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(SectionError, { sectionName: "Store Info", error: "No store information items found.", data: storeInfoData2 });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("section", { id: "storeInfo", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
      import_framer_motion9.motion.div,
      {
        ...
        className: "mb-16",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: sectionTitle })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12", children: storeInfoData2.items.map((item, index) => {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        import_framer_motion9.motion.div,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "flex items-start gap-5", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("h3", { className: "text-lg font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-2", children: t(item, "title") }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-[#1C1917] leading-relaxed", children: t(item, "content") })
          ] }) })
        },
        index
      );
    }) }),
    storeInfoData2.mainImage && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      import_framer_motion9.motion.div,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "aspect-video bg-[#FFFBF0] relative", children: [
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            "img",
            {
              src: storeInfoData2.mainImage,
              alt: t(storeInfoData2, "mainImageCaption"),
              className: "w-full h-full object-cover"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "absolute inset-0 bg-gradient-to-t from-[#0a0a0a]/90 to-transparent" }),
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { className: "absolute bottom-6 left-8 text-[#1C1917]", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("p", { className: "text-2xl font-sans font-bold tracking-normal font-bold tracking-wide tracking-tighter", children: t(storeInfoData2, "mainImageCaption") }) })
        ] })
      }
    )
  ] }) });
...
// src/components/themes/warm/Company.tsx
var import_framer_motion10 = require("framer-motion");
var import_jsx_runtime13 = require("react/jsx-runtime");
function Company() {
  const companyData2 = useCompanyData();
  const { getText } = useLocalize();
  if (!companyData2) return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SectionError, { sectionName: "Company", error: "No company data available", data: companyData2 });
  const sectionTitle = getText(companyData2.sectionTitle);
  const sectionSubtitle = getText(companyData2.sectionSubtitle);
  const hasPhilosophy = companyData2.philosophy && getText(companyData2.philosophy.title);
  const hasHistory = companyData2.history?.timeline && Array.isArray(companyData2.history.timeline) && companyData2.history.timeline.length > 0;
  const hasCompanyInfo = companyData2.companyInfo?.items && Array.isArray(companyData2.companyInfo.items) && companyData2.companyInfo.items.length > 0;
  if (!hasPhilosophy && !hasHistory && !hasCompanyInfo) {
    return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SectionError, { sectionName: "Company", error: "No company content found.", data: companyData2 });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("section", { id: "company", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#FFFBF0]", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "max-w-6xl mx-auto", children: [
    (sectionTitle || sectionSubtitle) && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
      import_framer_motion10.motion.div,
      {
        ...
        className: "mb-16",
        children: [
          sectionTitle && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mb-8" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-4 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: sectionTitle })
          ] }),
          sectionSubtitle && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "text-xl text-amber-900/80", children: sectionSubtitle })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "space-y-6", children: [
      hasPhilosophy && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        import_framer_motion10.motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          transition: { duration: 0.6 },
          className: "bg-[#FFFBF0] rounded-3xl border border-[#D97706]/20 p-8 md:p-12",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center gap-4 mb-6", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "bg-[#92400E]/20 border border-[#D97706]/30 p-4 rounded-2xl" }),
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { className: "text-4xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter", children: getText(companyData2.philosophy.title) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("p", { className: "text-amber-900/80 text-lg leading-relaxed", children: getText(companyData2.philosophy.content) })
          ]
        }
      ),
      hasHistory && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        import_framer_motion10.motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          className: "bg-[#FFFBF0] rounded-3xl border border-[#D97706]/20 p-8 md:p-12",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center gap-4 mb-8", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "bg-[#92400E]/20 border border-[#D97706]/30 p-4 rounded-2xl" }),
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { className: "text-4xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter", children: getText(companyData2.history.title) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "relative", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "absolute left-4 top-0 bottom-0 w-px bg-[#FFFBF0]" }),
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "space-y-6", children: companyData2.history.timeline.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
                import_framer_motion10.motion.div,
                {
                  initial: { opacity: 0, x: -20 },
                  whileInView: { opacity: 1, x: 0 },
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "absolute left-0 top-1 w-8 h-8 bg-[#92400E] rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "w-2.5 h-2.5 bg-white rounded-full" }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "bg-[#FFFBF0] rounded-xl p-4 border border-[#D97706]/20", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "font-sans font-bold tracking-normal font-bold tracking-wide text-[#D97706] mb-1", children: getText(item.year) }),
                      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "text-[#92400E]", children: getText(item.event) })
                    ] })
                  ]
                },
                index
      ...
      hasCompanyInfo && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
        import_framer_motion10.motion.div,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center gap-4 mb-8", children: [
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "bg-[#92400E]/20 border border-[#D97706]/30 p-4 rounded-2xl" }),
              /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("h3", { className: "text-4xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter", children: getText(companyData2.companyInfo.title) })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: companyData2.companyInfo.items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
              import_framer_motion10.motion.div,
              {
                initial: { opacity: 0, y: 20 },
                whileInView: { opacity: 1, y: 0 },
                ...
                className: "flex flex-col md:flex-row md:items-start gap-2 py-3 border-b border-[#D97706]/20",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "font-sans font-bold tracking-normal font-bold tracking-wide text-[#D97706] text-sm uppercase tracking-widest min-w-[120px]", children: getText(item.label) }),
                  /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "text-[#92400E] flex-1", children: getText(item.value) })
                ]
              },
              index
            )) })
...
// src/components/themes/warm/Access.tsx
var import_framer_motion11 = require("framer-motion");
var import_jsx_runtime14 = require("react/jsx-runtime");
function Access() {
  const accessData2 = useAccessData();
  const { getText } = useLocalize();
  const { language } = useLanguage();
  if (!accessData2) return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SectionError, { sectionName: "Access", error: "No access data available", data: accessData2 });
  const sectionTitle = getText(accessData2.sectionTitle);
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(SectionError, { sectionName: "Access", error: "Missing section title", data: accessData2 });
  const hasParking = accessData2.parking && typeof accessData2.parking === "object";
  const hasTransportation = accessData2.transportation && typeof accessData2.transportation === "object";
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("section", { id: "access", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
      import_framer_motion11.motion.div,
      {
        ...
        className: "mb-16",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-4 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: sectionTitle }),
          accessData2.sectionSubtitle && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-xl text-[#1C1917]", children: getText(accessData2.sectionSubtitle) })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
        import_framer_motion11.motion.div,
        {
          initial: { opacity: 0, x: -30 },
          ...
          children: [
            accessData2.address && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-start gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "bg-[#FFFBF0] border border-[#D97706] p-3 rounded-xl flex-shrink-0" }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h3", { className: "font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-1", children: translate("address", language) }),
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-[#1C1917]", children: getText(accessData2.address) })
              ] })
            ] }),
            hasParking && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "border-t border-[#D97706]/30 pt-6 flex items-start gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "bg-[#FFFBF0] border border-[#D97706] p-3 rounded-xl flex-shrink-0" }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h3", { className: "font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-1", children: getText(accessData2.parking.title) }),
                accessData2.parking.description && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-[#1C1917] text-sm mb-1", children: getText(accessData2.parking.description) }),
                accessData2.parking.spaces && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("p", { className: "text-[#D97706] font-sans font-bold tracking-normal font-bold text-sm", children: [
                  translate("parkingSpaces", language),
                  ": ",
                  getText(accessData2.parking.spaces)
                ] }),
                accessData2.parking.notes && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("p", { className: "text-amber-900/80 text-xs mt-1", children: getText(accessData2.parking.notes) })
              ] })
            ] }),
            hasTransportation && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "border-t border-[#D97706]/30 pt-6 flex items-start gap-4", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "bg-[#FFFBF0] border border-[#D97706] p-3 rounded-xl flex-shrink-0" }),
              /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("h3", { className: "font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] mb-3", children: getText(accessData2.transportation.title) }),
                /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "space-y-2", children: accessData2.transportation.methods && Array.isArray(accessData2.transportation.methods) && accessData2.transportation.methods.map((method, index) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-start gap-2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "w-1.5 h-1.5 bg-[#92400E] rounded-full mt-2 flex-shrink-0" }),
                  /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { children: [
                    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { className: "font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] text-sm", children: [
                      getText(method.type),
                      ":"
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "text-[#1C1917] text-sm ml-2", children: getText(method.description) })
                  ] })
                ] }, index)) })
              ] })
            ] })
      ...
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
        import_framer_motion11.motion.div,
        {
          ...
          transition: { duration: 0.6 },
          className: "rounded-3xl overflow-hidden border border-[#D97706]/30",
          children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "aspect-square bg-[#FFFBF0]", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
            "iframe",
            {
              src: accessData2.mapEmbedUrl,
              width: "100%",
              height: "100%",
              style: { border: 0 },
...
// src/components/themes/warm/FAQ.tsx
var import_framer_motion12 = require("framer-motion");
var import_react9 = require("react");
var import_jsx_runtime15 = require("react/jsx-runtime");
function FAQ() {
  const faqData2 = useFAQData();
  const { getText } = useLocalize();
  const [openIndex, setOpenIndex] = (0, import_react9.useState)(null);
  if (!faqData2) return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(SectionError, { sectionName: "FAQ", error: "No FAQ data available", data: faqData2 });
  const sectionTitle = getText(faqData2.sectionTitle);
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(SectionError, { sectionName: "FAQ", error: "Missing section title", data: faqData2 });
  if (!faqData2.items || !Array.isArray(faqData2.items) || faqData2.items.length === 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(SectionError, { sectionName: "FAQ", error: "No FAQ items found.", data: faqData2 });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("section", { id: "faq", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
      import_framer_motion12.motion.div,
      {
        ...
        className: "mb-16",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mb-8" }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-4 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: sectionTitle }),
          faqData2.sectionSubtitle && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: "text-xl text-[#1C1917]", children: getText(faqData2.sectionSubtitle) })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "space-y-3", children: faqData2.items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
      import_framer_motion12.motion.div,
      {
        initial: { opacity: 0, y: 20 },
        whileInView: { opacity: 1, y: 0 },
        viewport: { once: true },
        transition: { duration: 0.6, delay: Math.min(index * 0.08, 0.4) },
        className: "bg-white rounded-2xl border border-[#D97706]/30 overflow-hidden hover:border-[#D97706] transition-colors",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("h3", { className: "text-lg font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tight pr-4", children: getText(item.question) }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
            import_framer_motion12.motion.div,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "px-6 pb-6 pt-0", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "border-t border-[#D97706]/30 pt-4", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("p", { className: "text-[#1C1917] leading-relaxed", children: getText(item.answer) }) }) })
            }
          )
        ]
      },
...
// src/components/themes/warm/Contact.tsx
var import_framer_motion13 = require("framer-motion");
var import_react10 = require("react");
var import_jsx_runtime16 = require("react/jsx-runtime");
var import_meta = {};
var CONTACT_API_URL = import_meta.env.PUBLIC_CONTACT_API_URL || "";
function Contact() {
  const contactData2 = useContactData();
  const contactEmail = useContactEmail();
  const { t, translate: translate2 } = useLocalize();
  const [focused, setFocused] = (0, import_react10.useState)(null);
  const [submitStatus, setSubmitStatus] = (0, import_react10.useState)("idle");
  const [formData, setFormData] = (0, import_react10.useState)({ name: "", email: "", subject: "", message: "" });
  const [honeypot, setHoneypot] = (0, import_react10.useState)("");
  if (!contactData2) return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(SectionError, { sectionName: "Contact", error: "No contact data available", data: contactData2 });
  const sectionTitle = t(contactData2, "sectionTitle");
  if (!sectionTitle) return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(SectionError, { sectionName: "Contact", error: "Missing section title", data: contactData2 });
  if (!contactData2.fields) return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(SectionError, { sectionName: "Contact", error: "Missing contact form fields data", data: contactData2 });
  ...
  const inputBase = "w-full px-5 py-4 rounded-xl bg-white border-2 border-[#D97706]/30 text-[#1C1917] placeholder-slate-400 focus:outline-none transition-colors disabled:opacity-60 disabled:cursor-not-allowed";
  const inputFocused = "border-[#D97706]";
  const inputNormal = "border-[#D97706]/30";
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("section", { id: "contact", className: "py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white", children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "absolute left-1/2 -translate-x-1/2 w-[600px] h-64 bg-[#92400E]/5 rounded-full blur-[120px] pointer-events-none" }),
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "max-w-3xl mx-auto relative", children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
        import_framer_motion13.motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "w-16 h-1 bg-[#92400E] mx-auto mb-8" }),
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("h2", { className: "text-5xl md:text-7xl font-sans font-bold tracking-normal font-bold tracking-wide text-[#1C1917] tracking-tighter mb-6 border-b-2 border-[#D97706] pb-4 inline-block mb-4", children: t(contactData2, "sectionTitle") }),
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("p", { className: "text-xl text-[#1C1917]", children: t(contactData2, "sectionSubtitle") })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
        import_framer_motion13.motion.form,
        {
          initial: { opacity: 0, y: 30 },
          whileInView: { opacity: 1, y: 0 },
          viewport: { once: true },
          ...
          className: "bg-white rounded-3xl border border-[#D97706]/30 p-8 md:p-12 shadow-xl",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { display: "none" }, "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("input", { type: "text", name: "website", value: honeypot, onChange: (e) => setHoneypot(e.target.value), tabIndex: -1, autoComplete: "off" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "space-y-6", children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("label", { htmlFor: "name-t2", className: "block text-sm font-sans font-bold tracking-normal font-bold text-[#1C1917] uppercase tracking-widest mb-2", children: t(contactData2.fields, "name") }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("label", { htmlFor: "email-t2", className: "block text-sm font-sans font-bold tracking-normal font-bold text-[#1C1917] uppercase tracking-widest mb-2", children: t(contactData2.fields, "email") }),
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                  "input",
                  {
                    type: "email",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("label", { htmlFor: "subject-t2", className: "block text-sm font-sans font-bold tracking-normal font-bold text-[#1C1917] uppercase tracking-widest mb-2", children: t(contactData2.fields, "subject") }),
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                  "input",
                  {
                    type: "text",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("label", { htmlFor: "message-t2", className: "block text-sm font-sans font-bold tracking-normal font-bold text-[#1C1917] uppercase tracking-widest mb-2", children: t(contactData2.fields, "message") }),
                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                  "textarea",
                  {
                    id: "message-t2",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                import_framer_motion13.motion.button,
                {
                  type: "submit",
                  disabled: isDisabled,
                  className: "w-full bg-[#92400E] hover:bg-[#92400E] text-white py-5 rounded-2xl font-sans font-bold tracking-normal font-bold tracking-wide text-lg shadow-2xl shadow-[#92400E]/30 flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed transition-colors",
                  whileHover: !isDisabled ? { scale: 1.02, y: -2 } : {},
                  whileTap: !isDisabled ? { scale: 0.98 } : {},
                  children: t(contactData2, "submitButton")
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_framer_motion13.AnimatePresence, { children: [
                submitStatus === "success" && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                  import_framer_motion13.motion.div,
                  {
                    initial: { opacity: 0, y: 10 },
                    animate: { opacity: 1, y: 0 },
                    exit: { opacity: 0 },
                    className: "flex items-center gap-3 p-4 bg-[#FFFBF0] border border-[#D97706] rounded-xl text-[#D97706]",
                    children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "text-sm font-sans font-bold tracking-normal font-bold", children: translate2("contactSuccess") })
                  }
                ),
                submitStatus === "error" && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                  import_framer_motion13.motion.div,
                  {
                    initial: { opacity: 0, y: 10 },
                    animate: { opacity: 1, y: 0 },
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "text-sm font-sans font-bold tracking-normal font-bold", children: translate2("contactError") })
                  }
                )
              ] })
            ] })
...
// src/components/themes/warm/Footer.tsx
var import_react11 = require("react");
var import_framer_motion14 = require("framer-motion");
var import_jsx_runtime17 = require("react/jsx-runtime");
function Footer() {
  const footerData2 = useFooterData();
  const { getText, t } = useLocalize();
  const currentYear = (/* @__PURE__ */ new Date()).getFullYear();
  if (!footerData2) return null;
  const logoText = typeof footerData2.logo === "string" ? footerData2.logo : t(footerData2.logo, "text", "");
  const description = getText(footerData2.description);
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("footer", { className: "bg-[#FFFBF0] text-[#1C1917] pt-16 sm:pt-20 lg:pt-24 pb-10 sm:pb-12 px-4 sm:px-6 border-t border-[#D97706]/30", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-16 mb-20", children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "lg:col-span-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "flex items-center gap-3 mb-8 group", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "w-12 h-12 bg-[#92400E] rounded-2xl flex items-center justify-center rotate-12 group-hover:rotate-0 transition-transform duration-500" }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "text-4xl font-sans font-bold tracking-normal font-bold tracking-wide tracking-tighter uppercase", children: logoText })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "text-[#1C1917] text-lg leading-relaxed max-w-md font-medium", children: description })
      ] }),
      footerData2.businessHours && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("h3", { className: "text-sm font-sans font-bold tracking-normal font-bold tracking-wide uppercase tracking-[0.2em] text-[#D97706] mb-8", children: getText(footerData2.businessHours.title) }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "space-y-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "text-[#1C1917] font-sans font-bold tracking-normal font-bold tracking-wide text-xl", children: getText(footerData2.businessHours.days) }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "text-amber-900/80 font-medium", children: getText(footerData2.businessHours.hours) }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("p", { className: "text-[#92400E] text-sm italic", children: getText(footerData2.businessHours.closedDay) })
        ] })
      ] }),
      footerData2.social?.links && (() => {
        const validLinks = footerData2.social.links.filter(
          (s) => s.url && s.url.trim() !== "" && s.url.trim() !== "#"
        );
        if (validLinks.length === 0) return null;
        return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("h3", { className: "text-sm font-sans font-bold tracking-normal font-bold tracking-wide uppercase tracking-[0.2em] text-[#D97706] mb-8", children: getText(footerData2.social.title) }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "flex flex-wrap gap-4", children: validLinks.map((social, index) => {
            const platformName = typeof social.platform === "string" ? social.platform : getText(social.platform) || "";
            return /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
              import_framer_motion14.motion.a,
              {
                href: social.url,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "pt-12 border-t border-[#D97706]/30 flex flex-col md:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("p", { className: "text-[#92400E] text-sm font-sans font-bold tracking-normal font-bold tracking-widest uppercase", children: [
        "\xA9 ",
        currentYear,
        " ",
        getText(footerData2.copyright)
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("a", { href: "https://webdesign.neural-seeds.com/", target: "_blank", rel: "noopener noreferrer", className: "text-xs text-[#92400E] hover:text-[#1C1917] transition-colors", children: "Powered by Landy" })
    ] })
  ] }) });
}
...
var ErrorBoundary = class extends import_react12.Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { className: "min-h-screen flex items-center justify-center bg-red-50 p-4", children: /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "max-w-2xl w-full bg-white rounded-lg shadow-xl p-8", children: [
        /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "flex items-start gap-4 mb-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(import_lucide_react.AlertCircle, { className: "w-8 h-8 text-red-600 flex-shrink-0 mt-1" }),
          /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("h1", { className: "text-2xl font-bold text-red-900 mb-2", children: "Application Error" }),
            /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("p", { className: "text-red-800 mb-4", children: "Something went wrong while rendering the application. Please refresh the page or contact support." })
          ] })
        ] }),
        this.state.error && /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("details", { className: "mb-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("summary", { className: "cursor-pointer text-red-700 hover:text-red-900 font-medium mb-2", children: "Error Details" }),
          /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("div", { className: "bg-red-50 p-4 rounded border border-red-200 overflow-auto", children: [
            /* @__PURE__ */ (0, import_jsx_runtime18.jsxs)("p", { className: "font-mono text-sm text-red-900 mb-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("strong", { children: "Error:" }),
              " ",
              this.state.error.toString()
            ] }),
            this.state.errorInfo && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("pre", { className: "font-mono text-xs text-red-800 whitespace-pre-wrap", children: this.state.errorInfo.componentStack })
          ] })
        ] }),
...
function ThemeWarmStorePage({ pageData, initialLanguage = "ja", basePath = "/" }) {
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)(import_jsx_runtime19.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("style", { children: `
      ...
      ` }),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(ErrorBoundary_default, { children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(LanguageProvider, { initialLanguage, basePath, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(PageDataProvider, { data: pageData, children: /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { className: "relative w-full min-h-screen bg-[#FFFBF0] text-[#1C1917] selection:bg-blue-500/30 font-sans font-maru overflow-x-clip", children: [
      pageData.header && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Header, {}),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("main", { children: [
        pageData.hero && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Hero, {}),
        pageData.about && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(About, {}),
        pageData.menu && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Menu, {}),
        pageData.pricing && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Pricing, {}),
        pageData.cta && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(CTA, {}),
        pageData.gallery && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Gallery, {}),
        pageData.staff && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Staff, {}),
        pageData.news && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(News, {}),
        pageData.storeInfo && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(StoreInfo, {}),
        pageData.company && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Company, {}),
        pageData.access && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Access, {}),
        pageData.faq && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(FAQ, {}),
        pageData.contact && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Contact, {})
      ] }),
      pageData.footer && /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Footer, {})
    ] }) }) }) })
  ] });
}
