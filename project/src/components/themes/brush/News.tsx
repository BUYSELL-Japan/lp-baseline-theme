      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          {newsData.sectionSubtitle && (
            <p className="text-xl text-white">{getText(newsData.sectionSubtitle)}</p>
          )}
        </motion.div>
          ...
          {newsData.items.map((item: any, index: number) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ x: 6 }}
                className="group bg-transparent border border-[#333] rounded-2xl border border-[#C0392B]/30 hover:border-[#C0392B] hover:shadow-md p-6 md:p-8 transition-colors cursor-pointer"
              >
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  <div className="flex items-center gap-4 flex-shrink-0">
                    <div className="bg-transparent border border-white/20 p-3 rounded-xl border border-[#C0392B]">
                  ...
                  <div className="flex-grow">
                    <h3 className="text-xl font-serif tracking-widest text-white tracking-tight mb-2 group-hover:text-[#C0392B] transition-colors">
                      {title}
                    </h3>
                    <p className="text-white leading-relaxed text-sm">{content}</p>
                  </div>
                </div>
              </motion.div>
            );
