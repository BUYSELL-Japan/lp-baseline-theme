...
export default function FAQ() {
  ...
  return (
    <section id="faq" className="scroll-mt-20 py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          {faqData.sectionSubtitle && (
            <p className="text-xl text-[#1C1917]">{getText(faqData.sectionSubtitle)}</p>
          )}
        </motion.div>
        ...
        <div className="space-y-3">
          {faqData.items.map((item, index) => (
            ...
            >
              ...
              >
                <h3 className="text-lg font-sans font-bold tracking-normal text-[#1C1917] pr-4">
              ...
              >
                <div className="px-6 pb-6 pt-0">
                  <div className="border-t border-[#D97706]/30 pt-4">
                    <p className="text-[#1C1917] leading-relaxed">{getText(item.answer)}</p>
                  </div>
                </div>
              </motion.div>
            </motion.div>
