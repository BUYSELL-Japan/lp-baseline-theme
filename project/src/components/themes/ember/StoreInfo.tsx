...
export default function StoreInfo() {
  ...
  return (
    <section id="storeInfo" className="py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 bg-[#141414]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-serif font-bold tracking-wide text-gray-100 tracking-tighter border-b-2 border-[#D4AF37] pb-4 inline-block mb-4">
            {sectionTitle}
          </h2>
        </motion.div>
          ...
          {storeInfoData.items.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-[#141414] rounded-2xl border border-[#D4AF37]/30 hover:border-[#D4AF37] hover:shadow-md p-8 transition-colors"
              >
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold tracking-wide text-gray-100 mb-2">{t(item, 'title')}</h3>
          ...
          >
            <div className="aspect-video bg-[#1a1a1a] relative">
              ...
              <div className="absolute bottom-6 left-8 text-white">
                <p className="text-2xl font-serif font-bold tracking-wide tracking-tighter">{t(storeInfoData, 'mainImageCaption')}</p>
              </div>
            </div>
          </motion.div>
        )}
