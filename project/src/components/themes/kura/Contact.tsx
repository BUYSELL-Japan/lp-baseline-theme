...
export default function Contact() {
  ...
  const inputBase = "w-full px-5 py-4 rounded-xl bg-white border-2 border-[#C0392B]/30 text-[#2D2D2D] placeholder-slate-400 focus:outline-none transition-colors disabled:opacity-60 disabled:cursor-not-allowed";
  const inputFocused = "border-[#C0392B]";
  const inputNormal = "border-[#C0392B]/30";

  return (
    <section id="contact" className="py-16 sm:py-32 md:py-48 md:py-28 lg:py-32 px-4 sm:px-6 bg-white">
      {/* Glow accent */}
      ...
      <div className="max-w-3xl mx-auto relative">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-serif tracking-widest text-[#2D2D2D] tracking-tighter mb-6 border-b-2 border-[#C0392B] pb-4 inline-block mb-4">
        ...
        <motion.form
          ...
          className="bg-white rounded-3xl border border-[#C0392B]/30 p-8 md:p-12 shadow-xl"
        >
          {/* Honeypot */}
          ...
          <div className="space-y-6">
            {/* Name */}
            <div>
              <label htmlFor="name-t2" className="block text-sm font-serif tracking-wider text-[#2D2D2D] uppercase tracking-widest mb-2">
            ...
            {/* Email */}
            <div>
              <label htmlFor="email-t2" className="block text-sm font-serif tracking-wider text-[#2D2D2D] uppercase tracking-widest mb-2">
            ...
            {/* Subject */}
            <div>
              <label htmlFor="subject-t2" className="block text-sm font-serif tracking-wider text-[#2D2D2D] uppercase tracking-widest mb-2">
            ...
            {/* Message */}
            <div>
              <label htmlFor="message-t2" className="block text-sm font-serif tracking-wider text-[#2D2D2D] uppercase tracking-widest mb-2">
            ...
            <motion.button
              ...
              className="w-full bg-[#1a1a1a] hover:bg-[#1a1a1a] text-white py-5 rounded-2xl font-serif tracking-widest text-lg shadow-2xl shadow-[#1a1a1a]/30 flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
            ...
            <AnimatePresence>
              {submitStatus === 'success' && (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-4 bg-[#FFFFFF] border border-[#C0392B] rounded-xl text-[#C0392B]"
                >
