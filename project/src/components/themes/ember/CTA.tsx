...
export default function CTA() {
  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-28 lg:py-32 px-4 sm:px-6 overflow-hidden bg-[#0a0a0a]">
      ...
      {/* Blue glow accents */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#8B0000]/20 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#8B0000]/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          ...
          {ctaData.sectionSubtitle && (
            <p className="text-xl text-[#D4AF37] font-serif font-bold mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {ctaData.buttons.map((button, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.97 }}
                className={`inline-flex items-center gap-3 px-10 py-5 rounded-2xl text-lg font-serif font-bold tracking-wide transition-all shadow-2xl ${
                  button.type === 'primary'
                    ? 'bg-[#8B0000] text-white hover:bg-[#8B0000] shadow-[#8B0000]/30'
